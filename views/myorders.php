...
<div class="container-fluid     ">
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "SELECT o.* FROM orders o WHERE o.user_id = 12 AND o.date BETWEEN '$startDate 00:00:00' AND '$endDate 23:59:59' ORDER BY o.date DESC";
        $userOrders = DBModel::read($query);
        // var_dump($userOrders);
    } else {
    $userOrders = DBModel::read("SELECT orders.* FROM orders WHERE orders.user_id = 12 ORDER BY orders.date DESC");
    ...
    <div id="reloadDate" style="width: 80%; margin: auto; padding-top: 2%;">
        ...
        <table class="table table-striped table-info " style="text-align:center">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"><?php echo $uorder['date']; ?></th>
